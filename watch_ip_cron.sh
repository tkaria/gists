...
save_ip_filename="/tmp/current_ip.txt"
##while [ 1 ]
  ##do IPADR2=$IPADR;
...
E_O_M
    ...
    echo IP Address \($IPADR\) is the same as of $dttim  >> $output_filename
    mail -s "IP UNCHANGED" tkaria@gmail.com << EOM
