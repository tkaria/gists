...
pan_be_N_t  PAN_BE_N_BACKEND_LIST[] =
{
    ...
    PANTHEIOS_BE_N_STDFORM_ENTRY(beid_Syslog, pantheios_be_file, PANTHEIOS_BE_N_F_ID_MUST_MATCH_CUSTOM28),
...
static int main_(int argc, char** argv)
{
  ...
  pantheios_fe_simple_setSeverityCeiling(pantheios::SEV_DEBUG);
